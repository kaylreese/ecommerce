                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="button_link" value="{{ old('button_link', $partner->button_link) }}" placeholder="Enter Button Link">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="state" class="form-control">
                                    <option {{ ($partner->state) == 1 ? 'selected' : '' }} value="1">Active</option>
                                    <option {{ ($partner->state) == 0 ? 'selected' : '' }} value="0">Inactive</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if (!empty($partner->getImage()))
                                    <img style="width: 200px" src="{{ $partner->getImage() }}">
                                @endif
                            </div>
                        </div>
                    </div>
